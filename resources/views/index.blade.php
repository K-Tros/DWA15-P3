...
@section('nav')
    <nav class='navbar navbar-default'>
        <ul class='nav navbar-nav'>
            <li class='active'><a href='/Project3/public/'>Home</a></li>
...
@section('content')
    ...
    <a href='/Project3/public/lorem-ipsum'>Lorem Ipsum Generator</a>
    <h2>Random User Generator</h2>
    <p>Like lorem ipsum, only with people! Amazing!</p>
    <a href='/Project3/public/user-generator'>User Generator</a>
@stop
